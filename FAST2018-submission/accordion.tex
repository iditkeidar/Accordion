...
The accuracy of $u$ at a given point in time depends on the number of merges that occurred since the last disk flush
or data-merge.
...
is roughly one half of the relevant data, since the pipe holds $S-1$ unmerged components. 
