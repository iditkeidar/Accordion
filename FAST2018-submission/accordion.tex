...
Each entry in a skiplist or  an array holds a reference to a \emph{cell} object.
...
objects, and has the off-heap array entries in the flat segments point directly to the the off-heap mslabs. Removing the cell objects yields
