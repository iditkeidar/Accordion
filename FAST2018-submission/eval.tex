...
a single cell. Such small values are typical in many production workloads~\cite{Wo2015}. 
...
in parallel from 12 client threads. We study the Zipf and the uniform key distributions. (The latter is less 
representative of real workloads -- presented for reference only). 
