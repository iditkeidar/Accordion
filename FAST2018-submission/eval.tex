...
\caption{Write throughput speedup vs \none\/ (legacy) achieved by \sys\/ with \basic\/ and \adp\/ policies. 
...
HBase operators odten choose placing log files on inexpensive hard disks, since they are only needed for recovery,
