...
This new design has three key benefits: First, the static segments have an optimized memory
 layout (flat index), which reduces their footprint and improves hardware cache efficiency. 
...
uses timeouts to detect faulty storage nodes and initiate fail-over.
