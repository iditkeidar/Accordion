...
In this work, we showed that applying the LSM tree principles also to RAM can improve performance and reduce disk wear. 
We presented \sys, an algorithm for 
