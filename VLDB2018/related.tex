\inpurple{The basis for LSM data structures is the \emph{logarithmic
...
\inpurple{Facebook's RocksDB~\cite{rocksdb} is the state-of-the-art implementation of a key-value store.
